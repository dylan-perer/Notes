...
```c#
/*
	1. our C# code gets converted to an INTERMEDIATE LANGUAGE(IL code) --- BUILD PROCESS
	2. Then when the application actually runs JIT will come and compile IL code to machine code --- RUN PROGRAM
